...
import com.example.admindashboardproject.admin.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCustomerNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse("CUSTOMER_NOT_FOUND",e.getMessage()));
    }
